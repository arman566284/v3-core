...
import { NexusV3PoolSwapTest } from '../typechain/NexusV3PoolSwapTest'
...
describe('NexusV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('NexusV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as NexusV3PoolSwapTest
          ...
          let tester: NexusV3PoolSwapTest
