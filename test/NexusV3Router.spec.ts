...
describe('NexusV3Pool', () => {
  ...
  let pool0: MockTimeNexusV3Pool
  let pool1: MockTimeNexusV3Pool
  ...
  let swapTargetCallee: TestNexusV3Callee
  let swapTargetRouter: TestNexusV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeNexusV3Pool, any]> => {
