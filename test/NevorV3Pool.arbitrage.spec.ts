...
import { NevorV3PoolSwapTest } from '../typechain/NevorV3PoolSwapTest'
...
describe('NevorV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('NevorV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as NevorV3PoolSwapTest
          ...
          let tester: NevorV3PoolSwapTest
