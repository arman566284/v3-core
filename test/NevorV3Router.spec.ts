...
describe('NevorV3Pool', () => {
  ...
  let pool0: MockTimeNevorV3Pool
  let pool1: MockTimeNevorV3Pool
  ...
  let swapTargetCallee: TestNevorV3Callee
  let swapTargetRouter: TestNevorV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeNevorV3Pool, any]> => {
